<?php
	...
	defined( 'ABSPATH' ) || die();
 	class Harika_Dynamic_Select_Input_Module {
		...
		public function init() {
			add_action( 'wp_ajax_harika_dynamic_select_input_data', array( $this, 'getSelectInputData' ) );
		}
		...
		public function getSelectInputData() {
			...
			try {
				if ( ! wp_verify_nonce( $nonce, 'harika_dynamic_select' ) ) {
	...
	function harika_dynamic_select_input_module() {

		return Harika_Dynamic_Select_Input_Module::get_instance();
	}
	harika_dynamic_select_input_module()->init();
