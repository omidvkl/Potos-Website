    ...
    $(window).on("elementor:init", function () {
        var widget = elementor.modules.controls.BaseData.extend({
            ...
            getValueTitles: function () {
                ...
                var params = {
                    action: harika_dynamic_select.action,
                    security: harika_dynamic_select.nonce,
                    ids: ids
                };
            ...
            onReady: function () {
                ...
                this.ui.select.select2({
                    ...
                    placeholder: self.model.get("placeholder") ? self.model.get("placeholder") : "جستجو و انتخاب کنید",
                    allowClear: true,
                    ajax: {
                        url: ajaxurl,
                        dataType: "json",
        ...
        elementor.addControlView("harika-dynamic-select", widget)
    })
}(jQuery);