...
class Harika_List3_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 1,
                'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget' => 'grid-template-columns: repeat({{SIZE}},1fr);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
                ...
                'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget .article .featured-image' => 'height: {{SIZE}}{{UNIT}};',
				],
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget .article .featured-image' => 'width: {{SIZE}}px;',
				],
        ...
        $this->add_control(
			...
			[
				...
				'default' => '1.2',
				'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget .article:hover .featured-image img' => 'transform: scale({{VALUE}});',
				],
			]
		);
        $this->add_responsive_control(
			...
			[
                ...
                'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget .featured-image img' => 'transition: {{SIZE}}s;',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget' => 'grid-column-gap: {{SIZE}}{{UNIT}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget' => 'grid-row-gap: {{SIZE}}{{UNIT}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .harika-posts-list-3-widget .content .title, {{WRAPPER}} .harika-posts-list-3-widget .content .title a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .harika-posts-list-3-widget .featured-image, {{WRAPPER}} .harika-posts-list-3-widget .article' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		echo '<div class="harika-posts-list-3-widget harika-post-widget harika-post-grid a-list-layout '.$item_limit.'">';
