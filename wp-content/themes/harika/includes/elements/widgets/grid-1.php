...
class Harika_Grid1_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'پست شبکه ای 1', 'harika' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 1,
                'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget' => 'grid-template-columns: repeat({{SIZE}},1fr);',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget .article .featured-image' => 'height: {{SIZE}}{{UNIT}};',
				],
        ...
        $this->add_control(
			...
			[
				...
				'default' => '1.2',
				'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget .article:hover .featured-image img' => 'transform: scale({{VALUE}});',
				],
			]
		);
        $this->add_responsive_control(
			...
			[
                ...
                'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget .featured-image img' => 'transition: {{SIZE}}s;',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget' => 'grid-column-gap: {{SIZE}}{{UNIT}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget' => 'grid-row-gap: {{SIZE}}{{UNIT}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .harika-posts-grid-1-widget .content .title, {{WRAPPER}} .harika-posts-grid-1-widget .content .title a',
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .harika-posts-grid-1-widget .content .excerpt, {{WRAPPER}} .harika-posts-grid-1-widget .content .excerpt p',
				'condition' => [
					'show_excerpt' => 'yes',
                ],
			]
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .harika-posts-grid-1-widget .featured-image, {{WRAPPER}} .harika-posts-grid-1-widget .article' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		echo '<div class="harika-posts-grid-1-widget harika-post-widget harika-post-grid a-grid-layout '.$item_limit.'">';
